import IMG_TEST from '@/assets/bg_login.png';
...
const ShotExtraction: React.FC = () => {
  ...
  const columns: ColumnsType<DataType> = [
    ...
    },
    {
      ...
      key: 'address',
      render: () => (
        <Avatar shape="square" size={58} src={IMG_TEST} alt="形象" />
      ),
    },
    {
      title: '训练结果',
    ...
    },
    {
      ...
      render: (_, record) => (
        <Space size="middle">
          ...
          <Button type="link" onClick={() => setOpenExtract(true)}>
            提脸
          </Button>
          <Button type="link" danger>
            重新提取
          </Button>
          <Button type="link">训练</Button>
      ...
      >
        ...
        >
          <Form.Item name="note" label="模型名称" rules={[{ required: true }]}>
            <Select placeholder="请选择模型名称" />
          </Form.Item>
          <Form.Item name="num" label="迭代次数" rules={[{ required: true }]}>
            <Input placeholder="请输入迭代次数" />
          </Form.Item>
        </Form>
      </Modal>
